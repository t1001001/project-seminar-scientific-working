...
Figure~\ref{fig:cyclegan_example} shows two CycleGAN-generated CT slices; Figure~\ref{fig:aug_examples} shows appearance-level augmentations (contrast, brightness, blur, noise, CLAHE) applied to a representative slice.

\begin{figure}[H]
\centering
\includegraphics[width=0.3\linewidth]{figs/cyc_1.3.6.1.4.1.14519.5.2.1.6279.6001.100621383016233746780170740405_0142_fake_A.png}\hspace{0.05\linewidth}
