...
\subsection{Novelty} % Cumi
\subsection{Expected Contributions} % Cumi
\subsection{Research Gap} % Tobi
\subsection{Research Questions} % Tobi
\subsection{Methodology} % Tobi
\subsection{Expected Contributions} % Cumi
% ------------------------------------------------------------
\section{Related Work}
\subsection{Generative Adversarial Networks in Medical Imaging} % Tobi
\subsection{Object Detection in Medical Imaging} % Tobi
\subsection{Positioning of this Work} % Tobi
\subsection{Expected Results} % Cumi
%
% ---- Bibliography ----
%
